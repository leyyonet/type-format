...
@Fqn(...FQN_NAME)
@AssignCast('Folder')
class FolderFormat extends AbstractFormat<_T, _O> implements FolderCast {
    protected static _defCanBeAbsolute = true;
    protected static _defIsLinux = true;
    protected static _defRestricted = false;

    defCanBeAbsolute(value: boolean): FolderCast {
        FolderFormat._defCanBeAbsolute = leyyo.primitive.boolean(value) ?? false;
        return this;
    }

    defIsLinux(value: boolean): FolderCast {
        FolderFormat._defIsLinux = leyyo.primitive.boolean(value) ?? false;
        return this;
    }

    defRestricted(value: boolean): FolderCast {
        FolderFormat._defRestricted = leyyo.primitive.boolean(value) ?? false;
        return this;
    }
...
export const folderFormat = new FolderFormat();