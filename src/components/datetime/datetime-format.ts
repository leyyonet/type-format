...
class DatetimeFormat extends AbstractFormat<_T, _O> {
    @memoize({})
    ...
    cast(value: unknown, opt?: _O): _T {
        ...
        return dateType.ly_validate(date ? date.toISOString() : null, opt);
    }
...
export const datetimeFormat = new DatetimeFormat();